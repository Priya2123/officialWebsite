...
const getPaperBackground = style("mode", {
  light: "#EEE",
  dark: "#111",
});
const getPaperForeground = style("mode", {
  light: "#111",
  dark: "#EEE",
});
...
body{ 
  ...
  color: ${getForeground};
   ...
   ${
     "" /* paper{
  background-color: ${getPaperBackground};
  color: ${getPaperForeground};
            ...
            <Container fixed>
              ...
              <Grid container spacing={5}>
                <Grid item xs={12} sm={12} md={12} lg={6} xl={6}>
                  ...
                  <h6 style={{ color: "#565656" }}>
                    The motive is to create a local ecosystem of Developers in
                ...
                <Grid container spacing={3} style={{ marginTop: "50px" }}>
                  ...
                  <Grid item xs={12} lg={6} xl={6} className={classes.TeamGrid}>
                    ...
                    <h6 style={{ color: "#565656" }}>
                      These are the amazing bunch of people who make the
                      community what it is. Who are the Backbone of Developer
                      Student Club, TIET and ensure that we can forge ahead
                    ...
                    <CardActionArea>
                      ...
                      <CardContent style={{ height: "120px" }}>
                        ...
                        <Typography
                          ...
                          component="p"
                        >
                          Attend Study Jams/ Hackathons/ Developer Conferences
              ...
              <Grid container spacing={2}>
                ...
                <Grid item lg={6} xl={6}>
                  ...
                  <h6 style={{ color: "#565656" }}>
                    ...
                    Chand Thapar. The institute has been granted full autonomy
                    and the status of deemed-to-be-university by the University
                    Grants Commission.
                  </h6>
